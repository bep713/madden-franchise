    ...
    describe('post-open tests', () => {
            ...
            describe('PopularityComponentTable', () => {
                ...
                it('can get a binary reference to a record', () => {
                    ...
                    expect(reference).to.eql(
                        '00100000100100100000000000000110'
                    );
                });
                ...
                describe('reads records', () => {
                    ...
                    it('reads records correctly', () => {
                        ...
                        expect(record.Player0).to.eql(
                            '00100000110110000000100010110100'
                        );
                        expect(record.Player1).to.eql(
                            '00100000110110000000001011111011'
                        );
                        ...
                        expect(record.hexData.slice(0, 10)).to.eql(
                            Buffer.from([
                                0x20, 0xd8, 0x08, 0xb4, 0x20, 0xd8, 0x02, 0xfb,
                                0x00, 0x00
                            ])
                        );
                    });
                                ...
                                file2.on('ready', () => {
                                    ...
                                    table2.readRecords().then(() => {
                                        ...
                                        expect(
                                            ...
                                            '00100000110110000000010110110010'
                                        );
                                        expect(
                                            table2.records[0].Player1
                                        ).to.eql(
                                            '00100000110110000000001000000001'
                                        );
                                        expect(
                ...
                describe('records have expected values', () => {
                    it('first record', () => {
                        ...
                        expect(record.SeasonStats).to.equal(
                            '00101101001011000000000000000000'
                        );
                    ...
                    it('Marcus Maye', () => {
                        ...
                        expect(record.GameStats).to.be.null;
                        expect(record.SeasonStats).to.equal(
                            '00101101001011000000010110111111'
                        );
                    ...
                    it('Baker Mayfield', () => {
                        ...
                        expect(record.GameStats).to.be.null;
                        expect(record.SeasonStats).to.equal(
                            '00101101001011000000010111000001'
                        );
        ...
        describe('can follow references', () => {
            it('can follow reference data correctly', () => {
                ...
                const expectedResult =
                    file.getTableById(playerTableId).records[763];
        ...
        describe('Tweet', () => {
            ...
            describe('can replace raw data', () => {
                ...
                it('re-read records from the same data', async () => {
                    ...
                    expect(table.records[3].Tweet).to.equal(
                ...
                it('can replace with modified data', async () => {
                    const modifiedData = fs.readFileSync(
                        path.join(
                            __dirname,
                            '../data/table-import/25_TweetTableModified.dat'
                        )
                    );
                    ...
                    expect(table.records[3].AuthorName).to.equal(
                        'Baker Mayfield'
                    );
                });
        ...
        describe('Coach', () => {
            ...
            it('field isChanged attribute is reset after saving', async () => {
                ...
                expect(table.records[138]._fieldsArray[13].isChanged).to.be
                    .true;
        ...
        describe('CharacterVisuals (table3)', () => {
            ...
            it('populates unformatted value correctly after setting the value', () => {
                ...
                expect(new IsonProcessor().isonVisualsToJson(data, 25)).to.eql(
                    existingData
                );
            });
            ...
            describe('handles scenario where data exists between the table3 size & data', () => {
                ...
                before((done) => {
                    ...
                    file3.on('ready', () => {
                        table = file3.getTableByUniqueId(
                            characterVisualsUniqueId
                        );
                        table.readRecords().then(() => {
                            done();
                ...
                it('can read the data', () => {
                    expect(
                        table.records[1400].RawData.length
                    ).to.be.greaterThan(0);
                    expect(
                        table.records[1400]._fields.RawData.thirdTableField.unformattedValue.readUInt8(
                            2
                        )
                    ).to.eql(7);
                });
                ...
                it('can set the data', (done) => {
                    ...
                    file3.save(filePathToSave).then(() => {
                        ...
                        file2.on('ready', async () => {
                            ...
                            expect(table2.records[1400].RawData).to.eql(

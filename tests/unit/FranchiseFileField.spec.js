...
let bin2FloatResponse = 0.5;
let dec2BinResponse = '1101010101';
let float2BinResponse = '1010101011001';

let utilService = {
    bin2dec: sinon.spy(() => {
        return bin2DecResponse;
    }),
    bin2Float: sinon.spy(() => {
        return bin2FloatResponse;
    }),
    dec2bin: sinon.spy(() => {
        return dec2BinResponse;
    }),
    float2Bin: sinon.spy(() => {
        return float2BinResponse;
    })
};

let valueSpy = sinon.spy(() => {
    return 'test';
});
...
describe('FranchiseFileField unit tests', () => {
    ...
    beforeEach(async () => {
        ...
        await quibble.esm(
            '../../src/FranchiseFileTable2Field.js',
            {},
            FranchiseFileTable2FieldMock
        );
        FranchiseFileField = (await import('../../src/FranchiseFileField.js'))
            .default;
    });
    ...
    describe('construtor', () => {
        ...
        describe('formatted value', () => {
            ...
            it('parses floats correctly', () => {
                ...
                field = new FranchiseFileField(
                    key,
                    Buffer.from([0x3e, 0x8c, 0xcc, 0xcd]),
                    offset
                );
            ...
            it('parses references correctly', () => {
                ...
                field = new FranchiseFileField(
                    key,
                    Buffer.from([0x36, 0xd4, 0x00, 0x01]),
                    offset
                );
            ...
            it('can get a value as if it were another type - ref', () => {
                ...
                expect(field.getValueAs(newOffset)).to.equal(
                    '00110110110101000000000000000001'
                );
            });
        });
    });
    ...
    describe('set value field', () => {
        describe('sets value field', () => {
            ...
            it('parses references correctly', () => {
                ...
                field = new FranchiseFileField(
                    key,
                    Buffer.from([0x36, 0xd4, 0x00, 0x00]),
                    offset,
                    parent
                );
        ...
        describe('sets unformatted value', () => {
            ...
            it('parses s_ints correctly', () => {
                ...
                expect(unformattedValue).to.eql(
                    Buffer.from([0x00, 0x00, 0x07, 0xfb])
                );
            });
            ...
            it('parses floats correctly', () => {
                ...
                expect(unformattedValue).to.eql(
                    Buffer.from([0x3f, 0x18, 0x05, 0xa2])
                );
            });
            ...
            it('parses references correctly', () => {
                ...
                expect(unformattedValue).to.eql(
                    Buffer.from([0x36, 0xd4, 0x00, 0x02])
                );
            });
    ...
    describe('second table scenario', () => {
        ...
        it('creates a second table field', () => {
            ...
            expect(FranchiseFileTable2FieldMock.firstCall.args[0]).to.eql(
                16,
                offset
            );
        });
    ...
    describe('get reference information', () => {
        ...
        beforeEach(() => {
            ...
            field = new FranchiseFileField(
                'TestReference',
                Buffer.from([0x39, 0xa8, 0x00, 0x01]),
                offset
            );
        });

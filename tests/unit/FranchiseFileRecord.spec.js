...
let utilServiceMock = {
    ...
    binaryBlockToDecimalBlock: sinon.spy(() => {
        return [25, 30, 60];
    })
};

let unformattedValueSpy = sinon.spy(() => {
    return '101010101011';
});
...
describe('FranchiseFileRecord unit tests', () => {
    ...
    beforeEach(async () => {
        ...
        await quibble.esm(
            '../../src/FranchiseFileField.js',
            {},
            FranchiseFileFieldMock
        );
        FranchiseFileRecord = (await import('../../src/FranchiseFileRecord.js'))
            .default;
    });

...
const M20TableStrategy = require('../../../../strategies/franchise/m20/M20TableStrategy');

describe('M20 Table Strategy unit tests', () => {
    describe('get table2 binary data', () => {
        it('gives expected result if all fields are parsed', () => {
            ...
            const result = M20TableStrategy.getTable2BinaryData(table2Records, oldData);
    ...
    describe('returns a list of mandatory offsets', () => {
        it('returns an empty list', () => {
            expect(M20TableStrategy.getMandatoryOffsets()).to.eql([]);
        });
    });
});
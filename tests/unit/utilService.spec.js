...
describe('util service unit tests', () => {
    describe('dec2bin', () => {
        ...
        it('can handle negative numbers', () => {
            expect(utilService.dec2bin(-5)).to.equal(
    ...
    describe('bin2Float', () => {
        it('converts a binary string into a float', () => {
            expect(
                utilService.bin2Float('00111110100000101000111101011100')
            ).to.equal(0.2549999952316284);
        });
    ...
    describe('float2Bin', () => {
        it('converts a float to a binary string and will pad result to 32 bits', () => {
            expect(utilService.float2Bin(0.2549999952316284)).to.equal(
                '00111110100000101000111101011100'
            );
        });
    });
    ...
    describe('replaceAt', () => {
        ...
        it('throws an error if given a negative offset', () => {
            let errorFn = () => {
                utilService.replaceAt('test', -1, 'hello');
            };
    ...
    describe('parse reference information', () => {
        it('returns expected result', () => {
            let result = utilService.getReferenceData(
                '00111101110001000000000000001011'
            );
